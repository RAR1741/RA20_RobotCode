...
public class Shooter {
   ...
   */
  public Shooter(TalonFX launcher) {
  ...
  public void manualControl(double power, double angleMotorPower) {
    ...
    launcher.set(TalonFXControlMode.PercentOutput, power);
  ...
  // return angleMotor.getEncoder().getPosition() /
  // angleMotor.getEncoder().getPositionConversionFactor();
  // }
  ...
  // targetAngle = degrees;
  // angleMotor.getPIDController().setReference(targetAngle,
  ...
  // return
  // angleMotor.getForwardLimitSwitch(LimitSwitchPolarity.kNormallyOpen).get();
  // }
